...
export default (variables = variable) => {
	...
	const headerTheme = {
		...
		"NativeBase.Left": {
			...
			alignSelf: "center",
			// alignItems: "flex-start",
			alignItems:  variable.float === "left" ? "flex-start" : "flex-start",
			flexDirection:  variable.float === "left" ? "row" : "row-reverse",
			justifyContent:  variable.float === "left" ? "flex-start" : "flex-start",
		},
		"NativeBase.Body": {
			flex: 1,
			alignItems: variable.float === "left" ? "flex-start" : "flex-end", // platform === "ios" && platformStyle !== "material" ? "center" : "flex-start",
			alignSelf: "center",
			"NativeBase.Segment": {
				borderWidth: 0,
				alignSelf: "flex-end",
		...
		"NativeBase.Right": {
			...
			flex: 1,
			alignSelf: "center",
			alignItems:  variable.float === "left" ? "flex-end" : "flex-end",
			flexDirection:  variable.float === "left" ? "row" : "row-reverse",
			justifyContent:  variable.float === "left" ? "flex-end" : "flex-end",
		},
		backgroundColor: variables.toolbarDefaultBg,
		flexDirection: variable.float === "left" ? "row" : "row-reverse", // "row",
